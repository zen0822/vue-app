...
exports.default = {
    ...
    methods: {
        ...
        enter: function (opt) {
            ...
            this.code = uid_1.default();
            var code = this.code;
            opt = __assign({}, opt, { code: code });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.beforeEnter(opt)];
                        case 1:
                            _a = (_d.sent());
                            _d.label = 2;
                        case 2:
                            ...
                            return [4 /*yield*/, this.entering(opt)];
                        case 3:
                            _b = (_d.sent());
                            _d.label = 4;
                        case 4:
                            ...
                            return [4 /*yield*/, this.afterEnter(opt)];
                        case 5:
                            _c = (_d.sent());
                            _d.label = 6;
                        case 6:
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _a = code === this.code;
                            if (!_a) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.beforeLeave(opt)];
                        case 1:
                            _a = (_d.sent());
                            _d.label = 2;
                        case 2:
                            ...
                            _b = code === this.code;
                            if (!_b) return [3 /*break*/, 4];
                            return [4 /*yield*/, this.leaveing(opt)];
                        case 3:
                            _b = (_d.sent());
                            _d.label = 4;
                        case 4:
                            ...
                            _c = code === this.code;
                            if (!_c) return [3 /*break*/, 6];
                            return [4 /*yield*/, this.afterLeave(opt)];
                        case 5:
                            _c = (_d.sent());
                            _d.label = 6;
                        case 6:
