    ...
    ServerMain.prototype.init = function () {
        ...
        this.resolvers = {
            Query: {
                ...
                feed: function (_root, args, context, _info) { return __awaiter(_this, void 0, void 0, function () {
                    var where, links;
            ...
            Mutation: __assign({}, Mutation_1.default, { postLink: function (_parent, args) {
                    var link = {
                    ...
                    links[linkIndex] = __assign({}, links[linkIndex], args);
    ...
    ServerMain.prototype.gql = function () {
        return {
            ...
            context: function (request) {
                return __assign({}, request, { prisma: prisma_1.prisma });
            }
        };
    };
    return ServerMain;
