...
var _mockrc_js_1 = __importDefault(require("../../.mockrc.js"));
...
var ServiceWorkerMain = /** @class */ (function () {
    ...
    ServiceWorkerMain.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                workboxRouting.registerRoute(new RegExp('http://localhost:5168/#/'), process.env.NODE_ENV === 'development'
    ...
    ServiceWorkerMain.prototype.registerRoute = function () {
        var _this = this;
        _mockrc_js_1.default.api.forEach(function (item) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
